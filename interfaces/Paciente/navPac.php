    ...
    <nav>
        <ul>
            <div class="nav-links">
                ...
                <li><a href="/interfaces/Paciente/misCredenciales.php"><i class="fa fa-id-card"></i> Mis Credenciales</a></li>
                <!--
                <li>
...
<div class="perfil-interactivo" id="perfil-img" title="Abrir menú">
    <?php
    // Determinar la imagen según el género
    $genero = $_SESSION['genero'] ?? 'Masculino'; // por defecto masculino
    $imgPerfil = ($genero === 'Femenino') 
        ? '/assets/img/loginFem.png' 
        : '/assets/img/loginMasc.png';
    ?>
    ...
    <div id="perfil-menu" class="perfil-menu">
        <ul>
            ...
            <li><a href="/interfaces/Paciente/miGrupoFamiliar.php"><i class="fa fa-user"></i> Grupo Familiar</a></li>
