    ...
    <nav>
        <ul>
            <div class="nav-links">
                ...
                <li><a href="/interfaces/tecnico/principalTecnico.php"><i class="fa fa-tachometer-alt"></i> Principal</a></li>
                <li><a href="agendaTecnico.php"><i class="fa fa-calendar-days"></i> Agenda</a></li>
                <li><a href="turnosTecnico.php"><i class="fa fa-calendar-check"></i> Turnos</a></li>
                <!--
                <li>
