...
$q        = trim((string)qget('q','')); // busca por paciente o médico
...
if ($q !== '') {
  // Busca en paciente y médico (nombre y apellido)
...
// Agregamos LIMIT/OFFSET a params
$params2 = $params;
$types2 = $types.'ii';
...
-->
  ...
  <main class="container">
    ...
    <div class="backbar">
      ...
      <a class="btn" href="agenda.php?tab=turnos"><i class="fa fa-calendar-plus"></i> Ir a Agenda</a>
    </div>
  ...
  <tr>
    ...
    <th style="width:180px">Acciones</th>
        ...
        <tbody>
  <?php if (empty($list)): ?>
    <tr><td colspan="9" style="color:#666">No hay turnos para los filtros aplicados.</td></tr>
  ...
  ?>
    <tr>
      ...
      <td>
        <a class="btn-outline sm" href="agenda.php?tab=turnos&action=edit&id=<?= (int)$t['id_turno'] ?>">
  ...
  <?php endforeach; endif; ?>
      ...
      <div class="pager">
        ...
        <?php endif; ?>
        <span style="padding:6px 10px;background:#fff;border:1px solid var(--border);border-radius:8px">Página <?= (int)$page ?> / <?= (int)$total_pages ?></span>
