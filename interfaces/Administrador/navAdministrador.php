    ...
    <nav>
        <ul>
            <div class="nav-links">
                ...
                <li><a href="abmMedicos.php"><i class="fa fa-user-doctor"></i> Médicos</a></li>
                <li><a href="abmTecnicos.php"><i class="fa fa-user-gear"></i> Técnicos</a></li>
                <li><a href="abmAdministrativos.php"><i class="fa fa-user-tie"></i> Administrativos</a></li>
                <li><a href="abmEspecialidades.php"><i class="fa fa-stethoscope"></i> Especialidades</a></li>
                <li><a href="abmEstudios.php"><i class="fa fa-file-medical"></i> Estudios</a></li>
                <li><a href="agenda.php"><i class="fa fa-calendar-days"></i> Turnos</a></li>
                <li><a href="reportes.php"><i class="fa fa-chart-line"></i> Reportes</a></li>                
                <!--
                <li>
