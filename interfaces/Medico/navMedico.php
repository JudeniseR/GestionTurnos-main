...
<header>
    <nav>
        <ul>
            <div class="nav-links">
                <li><a href="/index.php"><i class="fa fa-house"></i> Inicio</a></li>
                <li><a href="/interfaces/Medico/principalMed.php"><i class="fa fa-tachometer-alt"></i> Principal</a></li>
                <li><a href="agenda.php"><i class="fa fa-calendar-days"></i> Agenda</a></li>
                <li><a href="turnos.php"><i class="fa fa-calendar-check"></i> Turnos</a></li>
                <li><a href="ordenes_medicas.php"><i class="fa fa-file-medical"></i> Órdenes</a></li>
...
<div class="perfil">
    ...
    <div class="perfil-interactivo" id="perfil-img" title="Abrir menú">
        <img src="/assets/img/loginDoc.png" alt="Foto perfil">
